...
<body class="toggle-sidebar">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="add-project.html">Work Chart</a></li>
                <li><a class="dropdown-item" href="warrior-admin.html">Warrior Chart</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                <li><a class="dropdown-item" href="admin.html">View All Post</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown3">
                <li><a class="dropdown-item" href="#">Add Up coming</a></li>
                <li><a class="dropdown-item" href="#">Add Ongoing</a></li>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/img/logo-cong.jpg" alt="Profile" class="rounded-circle">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="d-md-flex justify-content-md-end">
           <a href="add-project.html"> <button type="button" class="btn btn-outline-secondary me-3 "  > <span>Topics</span></button></a>
          <button type="button" class="btn btn-success " data-bs-toggle="modal" data-bs-target="#verticalycentered"><i class="bi bi-upload"></i> <span> Add Topic</span></button>
        </div>
        </div>
      </div>
    </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-12">
              <select class="form-select" aria-label="Default select example">
                ...
                <option value="2">Pathanamthitta</option>
  ...
  <div class="modal fade" id="verticalycentered2" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Approve to</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form>
              ...
              <div class="card">
                <div class="filter opt-bg">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="#"> Approve</a>
                    </li>
                ...
                <div class="p-2">
                  <a class=" d-flex align-items-center pe-0 h-50 dark-lght" href="users-profile-details.html" >
                  <img src="assets/img/profile-img.jpg" alt="Profile" class="rounded-circle" width="50" >
                  <span class=" ps-2">K. Anderson <br> <small class="light-txt" >Ernakulam</small></span>
                ...
                <div class="card-body">
                  ...
                  <div>
                    <button type="button" class=" btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#verticalycentered2">Approve</button>
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card">
                ...
                <div class="p-2">
                  <a class=" d-flex align-items-center pe-0 h-50 dark-lght" href="users-profile-details.html" >
                  <img src="assets/img/profile-img.jpg" alt="Profile" class="rounded-circle" width="50" >
                  <span class=" ps-2">Mathew <br> <small class="light-txt" >Kottayam</small></span>
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card">
                ...
                <div class="p-2">
                  <a class=" d-flex align-items-center pe-0 h-50 dark-lght" href="users-profile-details.html" >
                  <img src="assets/img/profile-img.jpg" alt="Profile" class="rounded-circle" width="50" >
                  <span class=" ps-2">Kevin <br> <small class="light-txt" >Kannur</small></span>
