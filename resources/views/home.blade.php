  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <nav class="navbar navbar-expand-lg navbar-white ">
      <div class="container wdthmob">
        ...
        <div class="collapse navbar-collapse margin-topm " id="navbarSupportedContent">
    ...
    <nav class="header-nav ms-auto">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <a class="nav-link nav-icon mob-a-icn" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Admin" href="admin-login.html" >
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/img/bannr1.jpg" class="d-block w-100" alt="...">
        ...
        <div class="col-lg-8">
          <div class="row">
             ...
             <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card mb-3">
                ...
                <div class="filter opt-bg">
                  <a class="icon opt-txt" href="#" >21-05-23</a>
                  
                </div>

                <div class="card-body">
                  <h5 class="card-title">Create Social media post for xyz </h5>
                  <div class="d-flex align-items-center">
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                <div class="filter opt-bg">
                  <a class="icon opt-txt" href="#" >17-05-23</a>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="filter opt-bg">
                  <a class="icon opt-txt" href="#" >18-04-23</a>
            ...
            <div class="mb-5">
             <a href="projects.html"><button class=" btn btn-outline-secondary">View All</button></a> 
            </div>
